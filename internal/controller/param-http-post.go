...
type MessagePrivate struct {
	...
	Self_id      int64  `json:"self_id"`      //收到事件的机器人 QQ 号
	...
	Message_id   int32  `json:"message_id"`   //消息 ID
	User_id      int64  `json:"user_id"`      //发送者 QQ 号
	Message      string `json:"message"`      //消息内容
	Raw_message  string `json:"raw_message"`  //原始消息内容
	Font         int32  `json:"font"`         //字体
	//Sender       object  `json:"sender"`       //发送人信息
	Target_id   int64 `json:"target_id"`   //接收者 QQ 号
